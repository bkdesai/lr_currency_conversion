...
exports.addPackageDependencies = exports.getRootPkg = void 0;
...
function addPackageDependencies(collectedDependencies, baseDirPath, extraDependencies = []) {
    ...
    dependencies = project_1.default.copy.filterDependencies(dependencies);
    const dependencyDirs = dependencies
        .filter((dependency) => !project_1.default.presetInfo.isAutopreset ||
        dependency !== project_1.default.presetInfo.name)
        .map((dependency) => resolveDependencyDir(baseDirPath, packageJson, dependency))
        .filter((dependencyDir) => dependencyDir !== null && dependencyDir !== undefined);
